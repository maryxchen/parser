...
class Circle : Shape { //circle is inheriting from shapes
private:
    float radius;                  // The radius of the circle, exclusive to circle
...
public:
    ...
    // Destructor
    virtual ~Circle(); //remember, destructor must always be virtual
